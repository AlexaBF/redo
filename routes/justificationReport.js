            ...
            if(err){
                ...
                var daydetail = function ( report, data ) {
                    ...
                    report.band( [
                        ...
                        {data: data.FechaJustificada, width: 60, underline: false, zborder:{left:1, right: 1, top: 0, bottom: 1}}, //7
                        {data: data.MotivoJustificacion, width: 93, underline: false, zborder:{left:1, right: 1, top: 0, bottom: 1}}, //7
                ...
                var nameheader = function ( report, data ) {
                    ...
                    report.print( data.DiaJustificado, {fontBold: true, underline: true} );
                    report.band([
                        {data: 'Folio', width: 70},
                        ...
                        {data: 'Fecha justificada', width: 63},
